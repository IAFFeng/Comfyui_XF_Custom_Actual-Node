...
Original file is located at
    https://colab.research.google.com/drive/1s9yicfW8Lz89JY-fUnxbHRd3MJKAauBy
"""
...
class GeminiMattingNode:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                "image": ("IMAGE",),
                # 修改 Placeholder 以配合前端 JS 的点击提示逻辑
                "api_key": ("STRING", {"multiline": False, "default": "", "placeholder": "Click to set API Key..."}),
    ...
    def process_image(self, image, api_key, mode):
        if not api_key:
            raise ValueError("API Key is required. Please set it in the node settings.")
